  ...
  <script src="<?php echo uri::base().'assets/js/jquery-ui.min.js' ?>"></script>
        ...
        <small>Items</small>
          ...
          <!-- <div class="col-md-12 col-xs-12"> -->
            <div id="myid">
            <a href="<?php echo uri::base().'order/kitchenitem'?>"><button href="<?php  uri::base().'order/kitchenitem' ?>" class="btn1 active"  data-toggle="modal"> Kitchen Item</button></a>
            <a href="<?php echo uri::base().'order/baritem'?>"><button href="<?php echo uri::base().'order/baritem' ?>" class="btn1 "  data-toggle="modal"> Bar Item</button></a>
            </div>
...
// return false;
   $.ajax({
      ...
      cache:false,
      success:function(){
        location.href = '<?php echo uri::base().'order/kitchenitem'?>';
              }
  });
