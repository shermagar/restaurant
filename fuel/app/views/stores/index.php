...
<div class="modal fade" tabindex="-1" role="dialog" id="addModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo uri::base().'stores/create' ?>" method="post" id="createForm">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo uri::base().'stores/update' ?>" method="post" id="updateForm">
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo uri::base().'stores/remove' ?>" method="post" id="removeForm">
        <div class="modal-body">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base + 'stores/fetchCategoryData',
    'order': []
  });
...
{ 
  $.ajax({
    url: base + 'stores/fetchStoresDataById/'+id,
    type: 'post',
    dataType: 'json',
    success:function(response) {
